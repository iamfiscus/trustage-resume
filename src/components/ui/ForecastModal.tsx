...
export const forecastData: Record<string, ForecastData> = {
  ...
  mcp: {
    ...
    date: "January 15, 2026",
    methodology: "5-Phase Pipeline with explicit Anthropic bias correction",
    summary: [
      { forecast: "MCP dominant standard by 2028", probability: "7.0%", ci: "2-18%", confidence: "Low" },
      { forecast: "Major providers (2+) adopt by 2027", probability: "8.0%", ci: "2-20%", confidence: "Low" },
      { forecast: "10K servers by 2026", probability: "24.0%", ci: "12-42%", confidence: "Medium" },
      { forecast: "F500 >30% adoption by 2028", probability: "5.5%", ci: "1-15%", confidence: "Low" },
    ],
    keyInsights: [
      "Only ~10-20% of well-backed protocols achieve true dominance (>50% share)",
      "Major provider adoption is the key swing factor—OpenAI adopting would shift all forecasts dramatically",
      "Enterprise adoption faces structural barriers: security, compliance, vendor ecosystems",
      "Tail risks significant in both directions—single announcement could move 3-5x",
    ],
    killCriteria: [
      "OpenAI announces competing protocol → Dominant drops to 3%",
      "OpenAI announces MCP support → Dominant increases to 25%",
      "Major security breach via MCP → All forecasts -40%",
    ],
    failureModes: [
      { mode: "OpenAI releases superior alternative", probability: "30%" },
      { mode: "Google/Microsoft consortium standard", probability: "25%" },
      { mode: "AI architecture shift", probability: "20%" },
      { mode: "Fragmentation into incompatible versions", probability: "20%" },
    ],
  },
  agentic: {
