...
// Forecaster output data - sorted by horizon
const horizonItems = [
  {
    id: "mcp",
    name: "MCP",
    ...
    status: "58% dominance",
    stats: [
      { label: "Dominant", value: "58%" },
      { label: "Providers", value: "92%" },
    ],
    insight: "The USB-C of AI. When your competitors adopt your stack, you won.",
  ...
  },
  {
    ...
    horizon: "H1",
    horizonLabel: "Core",
    status: "72% key use cases",
    stats: [
      { label: "Surpass Cloud", value: "72%" },
      { label: "Mainstream", value: "10%" },
    ],
  ...
  },
  {
    ...
    horizon: "H2",
    horizonLabel: "Pilot",
    status: "62% enterprise adoption",
    stats: [
      { label: "Tools >60%", value: "62%" },
      { label: "AI Outage", value: "55%" },
    ],
    insight: "Prompt injection is permanent. Detection > prevention. Accept this now. You'll save yourself a quarter.",
  ...
  },
  {
    ...
    horizon: "H3",
    horizonLabel: "Watch",
    status: "68% retailers deploy",
    stats: [
      { label: "Retailers", value: "68%" },
      { label: "Consumer", value: "12%" },
    ],
    insight: "Members' AI will shop insurance. The robots are coming for your quote flow.",
